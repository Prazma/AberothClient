function App() {
    //declare new variable a
    var a;
    //get canvas element to draw on...
...
window.addEventListener("load", function() {
    console.log(5, "window.onload start");
    app = new App;
    console.log("the serum needed to modify is: " + app)
    console.log(5, "window.onload end")
});
